...
const page = {
    ...
    subtitle: isLogin 
        ? "Продолжить работу со своими чатами" 
        : "Один аккаунт для истории чатов",
    endpoint: isLogin ? "/api/auth/login" : "/api/auth/register",
    submit: isLogin ? "Продолжить" : "Создать аккаунт",
    link: isLogin
        ? 'Нет аккаунта <a href="/reqister.html" class="font-medium text-ink underline">Зарегистрироваться</a>'
        ...
        <div class="w-full max-w-sm">
            ...
            <section class="rounded-2xl font-semibold border border-stone-200 bg-white p-7 shadow-soft">
                ...
                <form id="authForm" class="space-y-4">
                    ...
                    <button type="submit" class="flex h-11 w-full items-center justify-center rounded-lg bg-stone-900 px-4 font-medium text-white hover:bg-black disabled:opacity-60">${page.submit}</button>
